...
public class EncryptedConfigProcessor {
    ...
    private static class EncryptedConfig implements Config {
        ...
        @Override public Config getSubConfig(String prefix) {
            // Wrap sub-config to preserve decryption for ENC(...) values
            return new EncryptedConfig(delegate.getSubConfig(prefix), key);
        }
