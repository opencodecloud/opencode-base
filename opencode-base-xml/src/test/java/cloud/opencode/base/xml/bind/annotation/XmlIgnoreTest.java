 ...
 */
@DisplayName("XmlIgnore Annotation Tests")
class XmlIgnoreTest {
    ...
    class RetentionAndTargetTests {
        ...
        void shouldHaveRuntimeRetention() {
            var retention = XmlIgnore.class.getAnnotation(java.lang.annotation.Retention.class);
        ...
        void shouldTargetFieldAndMethod() {
            var target = XmlIgnore.class.getAnnotation(java.lang.annotation.Target.class);
        ...
        void shouldBeDocumented() {
            assertThat(XmlIgnore.class.isAnnotationPresent(java.lang.annotation.Documented.class)).isTrue();
        }
    }
    ...
    class AnnotationPresenceTests {
        ...
        void shouldBePresentOnAnnotatedField() throws NoSuchFieldException {
            assertThat(getClass().getDeclaredField("ignoredField")
                .isAnnotationPresent(XmlIgnore.class)).isTrue();
        }
        ...
        void shouldNotBePresentOnUnannotatedField() throws NoSuchFieldException {
            assertThat(getClass().getDeclaredField("normalField")
                .isAnnotationPresent(XmlIgnore.class)).isFalse();
        }
    }
}
