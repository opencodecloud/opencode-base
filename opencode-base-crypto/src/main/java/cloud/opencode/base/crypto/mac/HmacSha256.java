 ...
 * HMAC-SHA256 实现 - 基于 SHA-256 的哈希消息认证码
 *
 * <p><strong>Features | 主要功能:</strong></p>
 * <ul>
 *   <li>HMAC-SHA256 message authentication - HMAC-SHA256 消息认证</li>
 ...
 */
public final class HmacSha256 implements Mac {

    private static final String ALGORITHM = "HmacSHA256";
    private static final int MAC_LENGTH = 32; // SHA-256 produces 32 bytes

    private final javax.crypto.Mac mac;

    private HmacSha256(SecretKey key) {
        try {
     ...
     * 使用给定密钥创建新的 HMAC-SHA256 实例
     *
     * @param key the secret key bytes
     * @return new HmacSha256 instance
    ...
    public static HmacSha256 of(byte[] key) {
        ...
        return new HmacSha256(new SecretKeySpec(key, ALGORITHM));
    }

    /**
     * Creates a new HMAC-SHA256 instance with the given SecretKey
     * 使用给定的 SecretKey 创建新的 HMAC-SHA256 实例
     *
