 ...
 * 图片读取异常
 *
 * <p>Exception thrown when image reading fails.</p>
 * <p>当图片读取失败时抛出的异常。</p>
 *
 *
 * <p><strong>Features | 主要功能:</strong></p>
 * <ul>
 *   <li>Exception for image reading failures - 图片读取失败的异常</li>
...
public class ImageReadException extends ImageIOException {
    ...
    /**
     * Create an image read exception
     * 创建图片读取异常
     *
     * @param message the error message | 错误消息
     */
    public ImageReadException(String message) {
        super(message, ImageErrorCode.READ_FAILED);
        this.path = null;
    }

    /**
     * Create an image read exception with path
     * 创建带路径的图片读取异常
     *
     * @param path the file path | 文件路径
     */
    public ImageReadException(Path path) {
        super("Failed to read image: " + path, ImageErrorCode.READ_FAILED);
        this.path = path;
    }

    /**
     * Create an image read exception with path and cause
     * 创建带路径和原因的图片读取异常
     *
     * @param path the file path | 文件路径
    ...
    public ImageReadException(Path path, Throwable cause) {
        super("Failed to read image: " + path, cause, ImageErrorCode.READ_FAILED);
        this.path = path;
    }

    /**
     * Create an image read exception with message and cause
     * 创建带消息和原因的图片读取异常
     *
     * @param message the error message | 错误消息
     * @param cause the cause | 原因
    ...
    public ImageReadException(String message, Throwable cause) {
        super(message, cause, ImageErrorCode.READ_FAILED);
        this.path = null;
    }
