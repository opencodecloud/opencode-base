...
class OpenCollectionExceptionTest {
    ...
    class InheritanceTests {
        ...
        @Test
        @DisplayName("是 OpenException 子类")
        ...
        @Test
        @DisplayName("组件名称为 Collections")
        void testComponentName() {
            OpenCollectionException ex = new OpenCollectionException("test");

            assertThat(ex.getComponent()).isEqualTo("Collections");
        }

        @Test
        @DisplayName("getMessage 包含组件前缀")
        void testGetMessageFormat() {
            OpenCollectionException ex = new OpenCollectionException("test message");

            assertThat(ex.getMessage()).isEqualTo("[Collections] test message");
        }

        @Test
        @DisplayName("catch(OpenException) 可以捕获")
        void testCatchableAsOpenException() {
            assertThatThrownBy(() -> {
    ...
    class FactoryMethodTests {
        ...
        void testEmptyCollection() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Collection is empty: list");
            assertThat(ex.getComponent()).isEqualTo("Collections");
        }
        ...
        void testEmptyCollectionNullType() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Collection is empty: null");
        }
        ...
        void testIndexOutOfBounds() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Index: 10, Size: 5");
        }
        ...
        void testIndexOutOfBoundsNegativeIndex() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Index: -1, Size: 5");
        }
        ...
        void testDuplicateKey() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Duplicate key: key1");
        }
        ...
        void testDuplicateKeyNull() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Duplicate key: null");
        }
        ...
        void testDuplicateKeyInteger() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Duplicate key: 42");
        }
        ...
        void testDuplicateValue() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Duplicate value: value1");
        }
        ...
        void testDuplicateValueNull() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Duplicate value: null");
        }
        ...
        void testNullElement() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Null element not allowed");
        }
        ...
        void testNullKey() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Null key not allowed");
        }
        ...
        void testNullValue() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Null value not allowed");
        }
        ...
        void testImmutableCollection() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Cannot modify immutable collection");
        }
        ...
        void testElementNotFound() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Element not found: element1");
        }
        ...
        void testElementNotFoundNull() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Element not found: null");
        }
        ...
        void testKeyNotFound() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Key not found: key1");
        }
        ...
        void testKeyNotFoundNull() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Key not found: null");
        }
        ...
        void testIllegalCapacity() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Illegal capacity: -5");
        }
        ...
        void testIllegalCapacityZero() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Illegal capacity: 0");
        }
        ...
        void testMultipleElementsFound() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Expected one element but found: 3");
        }
        ...
        void testMultipleElementsFoundTwo() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Expected one element but found: 2");
        }
        ...
        void testNegativeSize() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Size cannot be negative: -1");
        }
        ...
        void testNegativeSizeLarge() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Size cannot be negative: -1000");
        }
        ...
        void testUnsupportedOperation() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Unsupported operation: delete");
        }
        ...
        void testUnsupportedOperationNull() {
            ...
            assertThat(ex.getRawMessage()).isEqualTo("Unsupported operation: null");
        }
    }
    ...
    class ExceptionBehaviorTests {
        ...
        void testFactoryMethodExceptionCanBeThrown() {
            assertThatThrownBy(() -> {
              ...
              .hasMessageContaining("Collection is empty: set");
        }
